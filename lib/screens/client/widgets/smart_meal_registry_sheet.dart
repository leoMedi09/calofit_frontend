...
class _SmartMealRegistrySheetState extends State<SmartMealRegistrySheet> {
  ...
  double get totalKcal => _ingredients.fold(0, (sum, item) => sum + (item['kcal'] as num).toDouble());
  double get totalP => _ingredients.fold(0, (sum, item) => sum + (item['p'] as num).toDouble());
  double get totalC => _ingredients.fold(0, (sum, item) => sum + (item['c'] as num).toDouble());
  double get totalG => _ingredients.fold(0, (sum, item) => sum + (item['g'] as num).toDouble());
