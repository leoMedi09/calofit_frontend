              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 12),
                    _buildTextField(_confirmPasswordController, 'Confirmar Contraseña', Icons.lock_reset_rounded,
                        isPassword: true,
                        extraValidator: (v) => v != _passwordController.text ? 'Las contraseñas no coinciden' : null),
                            ...
                            Expanded(
                              child: Text(
                                ...
                                style: const TextStyle(
                                    color: Color(0xFFC62828), fontSize: 13, fontWeight: FontWeight.w600),
                              ),
                            ),
                          ],
                        ),
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        suffixIcon: isPasswordField
            ? IconButton(
                tooltip: 'Ver',
                icon: Icon(_persistedObscure ? Icons.visibility_off_rounded : Icons.visibility_rounded,
