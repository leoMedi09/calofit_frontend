    ...
    return Scaffold(
      ...
      body: _isLoading
          ...
          : Padding(
              ...
              const Text('Información Personal y Física', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
              const SizedBox(height: 15),
              ...
              DropdownButtonFormField<String>(
                ...
                decoration: const InputDecoration(labelText: 'Género', prefixIcon: Icon(Icons.person_outline), border: OutlineInputBorder()),
